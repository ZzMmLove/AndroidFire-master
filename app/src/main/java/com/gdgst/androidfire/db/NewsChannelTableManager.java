 ...
 *
 */
package com.gdgst.androidfire.db;


import com.gdgst.androidfire.R;
import com.gdgst.androidfire.api.ApiConstants;
...
/*    public static List<NewsChannelTable> loadNewsChannelsMine() {
    ...
    public static List<NewsChannelTable> loadNewsChannelsStatic() {
        ...
        for (int i = 0; i < channelName.size(); i++) {
            NewsChannelTable entity = new NewsChannelTable(channelName.get(i), channelId.get(i), ApiConstants.getType(channelId.get(i)), i <= 6, i, true);

package com.gdgst.androidfire.ui.news.adapter;
...
import com.gdgst.androidfire.bean.NewsPhotoDetail;
import com.gdgst.androidfire.bean.NewsSummary;
import com.gdgst.androidfire.ui.news.activity.NewsDetailActivity;
import com.gdgst.androidfire.ui.news.activity.NewsPhotoDetailActivity;
import com.gdgst.common.commonutils.DisplayUtil;
 ...
 * on 2016.09.10:49
 */
public class NewListAdapter  extends MultiItemRecycleViewAdapter<MessageData.DataBean.ListBean>
{
    public static final int TYPE_ITEM = 0;
    public static final int TYPE_PHOTO_ITEM =1;

    public NewListAdapter(Context context,final List<MessageData.DataBean.ListBean> datas)
    {
        super(context, datas, new MultiItemTypeSupport<MessageData.DataBean.ListBean>()
        {
...
//                }
            ...
            @Override
            public int getItemViewType(int position, MessageData.DataBean.ListBean msg)
            {
...
//                }
    ...
    @Override
    public void convert(ViewHolderHelper holder, MessageData.DataBean.ListBean newsSummary) {
...
//                break;
     ...
     * @param position
     */
    private void setItemValues(final ViewHolderHelper holder, final MessageData.DataBean.ListBean newsSummary, final int position) {
        String title = newsSummary.getTitle();
        if (title == null) {
            title = newsSummary.getTitle();
        }
        String ptime = newsSummary.getTid();
        String digest = newsSummary.getSummary();
        String imgSrc = newsSummary.getPic();
        ...
        holder.setOnClickListener(R.id.rl_root, new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NewsDetailActivity.startAction(mContext,holder.getView(R.id.news_summary_photo_iv),newsSummary.getTid(),newsSummary.getPic());

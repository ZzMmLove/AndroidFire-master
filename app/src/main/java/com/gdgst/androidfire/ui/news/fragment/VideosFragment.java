...
import com.gdgst.androidfire.ui.news.model.VideosListModel;
import com.gdgst.androidfire.ui.news.presenter.VideoListPresenter;
...
//                helper.setImageRoundUrl(R.id.iv_logo,videoData.getTopicImg());
                ...
                boolean setUp = jcVideoPlayerStandard.setUp(
                        ...
                        TextUtils.isEmpty(videoData.getRemark())?videoData.getName()+"":videoData.getName());
                LogUtils.logd(videoData.getName());
                if (setUp) {
                    Glide.with(mContext).load(videoData.getImg_url_s())

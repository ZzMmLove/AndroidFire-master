...
public class WriteView extends SurfaceView implements
     ...
     * 虚线效果
     */
    private PathEffect dotLineEffect = new DashPathEffect(new float[]{5, 5, 5, 5}, 1);
     ...
     * 默认手绘笔迹粗细
     */
    private static final int DEFAULT_HANDWRTING_STROKE_WIDTH = 50;
    ...
    /**练字的字体选择*/
    private String src_font = PractiseMainFragment.getChioceFonts();
    ...
    private void initView(Context context) {
        ...
        if (src_font == null){
            src_font = "fonts/xingkai.ttf";
        }
        Log.i("WriteView", "字体文件"+src_font);
    ...
    private void initPaint() {
        ...
        handwritingPaint.setColor(DEFAULT_PEN_COLOR); // 设置画笔的颜色
    ...
    private void drawLine(float stringWidth, Canvas canvas) {
        ...
        canvas.drawLine((rightTopX - leftTopX) / 2 + leftTopX, leftTopY,
                (rightBottomX - leftBottomX) / 2 + leftBottomX,

...
import com.gdgst.shuoke360.ui.main.model.RegisterModel;
import com.gdgst.shuoke360.ui.main.presenter.RegisterPresenter;
...
//    Button register;
    ...
    public void onClick(){
        ...
        if (passWord.equals("") || repeatPassword.equals("")){
          ...
          mPresenter.getRegisterResult("gstshuoke360", mob, repeatPassword);
        }
    }
    ...
    @Override
    public void returnRegisterResult(Result<UpdateUserinfo> result) {
